  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "mx-auto flex w-full max-w-shell items-center justify-between gap-3 px-6 transition-all duration-500 sm:gap-5 sm:px-10 lg:px-14",
        ...
        >
          ...
          <Link
            href="/"
            className="mx-2 shrink-0 px-2 transition-transform duration-500 ease-silk sm:mx-4 sm:px-4"
          ...
          <div className="flex min-w-0 flex-1 items-center justify-end gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-0.5 border-l border-line pl-2 sm:gap-1 sm:pl-3">
