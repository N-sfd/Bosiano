...
export const looks: ShopLook[] = [
  {
    ...
    dek: "Maison Vérane's soft-power uniform — blazer, wide-leg trouser, sculptural mule.",
    source: "campaign",
    ...
    hotspots: [
      ...
      { id: "h2", productId: "pleated-wide-leg-trouser", label: "Trouser", category: "clothing", x: 48, y: 62 },
  ...
  },
  {
    ...
    source: "editorial",
    sourceLabel: "The Bosianos Journal",
    ...
    hotspots: [
      ...
      { id: "h3", productId: "pleated-wide-leg-trouser", label: "Trouser", category: "clothing", x: 50, y: 70 },
  ...
  },
  {
    ...
    dek: "Uploaded by a Bosianos Club member — refined neutrals for city evenings.",
    source: "customer",
